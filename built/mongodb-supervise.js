...
var MongoSupervise = /** @class */ (function () {
    function MongoSupervise(childPid) {
        ...
        this.execPath = (0, path_1.resolve)(__dirname, 'bin');
    ...
    MongoSupervise.prototype.getSuperviseCommand = function () {
        var killerCommand = (0, path_1.resolve)(this.execPath, this.command);
        this.debug("getSuperviseCommand(): ".concat(killerCommand));
    ...
    MongoSupervise.prototype.isWindows = function () {
        ...
        this.debug("isWindows(): ".concat(isWindows));
        return isWindows;
    };
    MongoSupervise.prototype.runOnWindows = function () {
        this.debug("runOnWindows()");
        var command = this.getSuperviseCommand();
        this.monitorChild = (0, child_process_1.spawn)("cmd.exe", [command, this.parentPid.toString(), this.childPid.toString()]);
    };
    MongoSupervise.prototype.runOnLinux = function () {
        this.debug("runOnLinux()");
        var command = this.getSuperviseCommand();
        this.monitorChild = (0, child_process_1.spawn)(command, [this.parentPid.toString(), this.childPid.toString()]);
    };
